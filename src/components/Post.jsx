            ...
            <div className = "post-header">
                <div className = "author-container"></div>
                    <h3 className = "author-name" onClick={()=> setIsOpen(!isOpen)}>
                        {post.author} <span className= "dropdown-arrow">V</span>
                    </h3>
                    ...
                    {isOpen && (
                        <div className ="user-menu-dropdown">
                            ...
                            {!isOwner && (
                                <>
                                    <button onClick={() => alert("Connection Request Sent")}>Connect</button>
                                    <button onClick={() => alert("Added to Group")}>Add to Group</button>
                                    <button onClick={() => alert("Direct Message Opened")}>Message</button>
                                </>
                            )}
                        </div>
                    )}
